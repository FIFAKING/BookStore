...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 70f61172-386a-4ca6-9a73-7c70f4204a0c
```

> `70f61172-386a-4ca6-9a73-7c70f4204a0c` is the password of the certificate, you can change it to any password you want.
